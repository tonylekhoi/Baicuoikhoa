...
//             const productElement = this.closest('.tiny');
//             const product = {
//                 name: productElement.querySelector('.sentences').textContent,
//                 price: productElement.querySelector('.money').textContent,
...
//             // Extract numeric price (remove all non-digit characters)
